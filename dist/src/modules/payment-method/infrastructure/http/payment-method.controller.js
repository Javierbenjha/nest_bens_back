...
__decorate([
    (0, common_1.Post)(),
    openapi.ApiResponse({ status: 201, type: require("../../domain/payment-method.entity").PaymentMethod }),
...
__decorate([
    (0, common_1.Get)(),
    openapi.ApiResponse({ status: 200, type: [require("../../domain/payment-method.entity").PaymentMethod] }),
    __metadata("design:type", Function),
