...
const size_service_1 = require("../../application/size.service");
...
__decorate([
    (0, common_1.Post)(),
    openapi.ApiResponse({ status: 201, type: require("../../domain/size.entity").Size }),
...
__decorate([
    (0, common_1.Get)(),
    openapi.ApiResponse({ status: 200, type: [require("../../domain/size.entity").Size] }),
    __metadata("design:type", Function),
