...
const items_service_1 = require("../../application/items.service");
...
__decorate([
    (0, common_1.Post)(),
    openapi.ApiResponse({ status: 201, type: require("../../domain/item.entity").Item }),
...
__decorate([
    (0, common_1.Get)(),
    openapi.ApiResponse({ status: 200, type: [require("../../domain/item.entity").Item] }),
    __metadata("design:type", Function),
