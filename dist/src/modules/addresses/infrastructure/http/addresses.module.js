...
const prisma_address_repository_1 = require("../persistence/prisma-address.repository");
...
exports.AddressesModule = AddressesModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [
            { provide: 'AddressRepository', useClass: prisma_address_repository_1.PrismaAddressRepository },
